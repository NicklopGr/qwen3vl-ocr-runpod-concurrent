...
# 48GB GPU (L40S): 3 for 30B-AWQ, 5 for 8B-FP8
# 80GB GPU (A100): 4-5 for 30B-AWQ
...
#   QuantTrio/Qwen3-VL-30B-A3B-Instruct-AWQ  (~17GB, AWQ 4-bit, MoE 30B/3B active)
#   Qwen/Qwen3-VL-30B-A3B-Instruct-FP8      (~30GB, FP8, needs 80GB GPU)
